import telebot, datetime, time, math, re, os
from telebot import types

BOT_TOKEN = 'bot_token' # Токен Телеграм-бота
BOT_NAME = 'skytorin_bot' # Имя для бота. Нужно в том случае, если вы хотите обращаться к боту по имени
