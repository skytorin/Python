# Создание функции для заполнения библиотеки:
...
# Функция с возмозностью указания произвольного кол-ва персон, заранее не определенных 
# (указывается в конце определения):
